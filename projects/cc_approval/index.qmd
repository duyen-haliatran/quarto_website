...
<p><img src="https://assets.datacamp.com/production/project_558/img/credit_card.jpg" alt="Credit card being held in hand" alt="" width="700" height="450"></p>
...
```{python}
#| dc: {key: '3'}
#| outputsMetadata: {'0': {height: 137, type: stream}}
#| tags: [sample_code]
# Import pandas
import pandas as pd
...
```{python}
#| dc: {key: '10'}
#| outputsMetadata: {'0': {height: 616, type: stream}}
#| tags: [sample_code]
...
```{python}
#| dc: {key: '66'}
#| outputsMetadata: {'0': {height: 37, type: stream}}
#| tags: [sample_code]
