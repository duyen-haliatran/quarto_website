...
```{python}
#| title: Gains curves for training & test set of logistic regression model
import pandas as pd
import numpy as np
import pyrsm as rsm
...
```{python}
#| title: Uplift plot - Proporposity Model
fig = rsm.uplift_plot(
...
```{python}
#| title: Compare Uplift model and Propensity model
fig = rsm.inc_uplift_plot(
    cg_rct_stacked.query("training == 0"),
    "converted",
    "yes",
